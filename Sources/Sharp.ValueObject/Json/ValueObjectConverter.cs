...
{
    public abstract class ValueObjectConverter<TValue, TValueObject> : JsonConverter<TValueObject>
        ...
        where TValueObject : ValueObject<TValue, TValueObject>
    {
        ...
        protected abstract TValue? ReadValue(ref Utf8JsonReader reader, JsonSerializerOptions options);
    }
}
